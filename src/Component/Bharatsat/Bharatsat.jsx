                ...
                <div className="container">
                    <div className=" d-flex justify-content-center">
                        <div class="title text-center">
                            ...
                            <p>Welcome to Bharat SAT, a flagship initiative of the "Learn Tech Service" Edutech project, aimed at transforming the educational landscape of India. Bharat SAT is an All India level examination specially designed for K12 classes, catering to students from 1st to 12th standard. This initiative stands out for its unique approach, combining competition and diagnosis to empower students on their educational journey.</p>
                        </div>
                    </div>
                    <div className="row">

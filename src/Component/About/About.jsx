            ...
            <div className="row">
              <div className="col-lg-7 col-md-8">
                <div className="bread-content">
                  <h3 className="title">About Learn Tech Service</h3>
            ...
            <div className="row">
              <div className="col-lg-6 col-md-9">
                <div className="connt connt-1">
                  ...
                  <p>At Learn Tech Service, we are a passionate group of young individuals with diverse backgrounds and dynamic personalities who share a common vision: to revolutionize the Indian educational system...</p>
                  <div className="img">
              ...
              <div className="col-lg-6 col-md-9">
                <div className="connt connt-4">
                  ...
                  <p>Learn Tech Service is dedicated to enhancing the educational experience of students across India. We invite you to join us on this remarkable journey to build a brighter future for the next generation. </p>
                  <div className="img">

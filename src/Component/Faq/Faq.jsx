                    ...
                    <Tab eventKey="home" title="General" className="tabs">
                        < Accordion defaultActiveKey="0">
                            <Accordion.Item eventKey="0">
                                <Accordion.Header className='faqhead'>What is Learn Tech Service Edutech Project?</Accordion.Header>
                                <Accordion.Body className='faqbody'>
                                <p>Learn Tech Service is an educational initiative aimed at providing innovative learning solutions to students across India.</p>
                                </Accordion.Body>
                            </Accordion.Item>
                            ...
                            <Accordion.Item eventKey="4">
                                <Accordion.Header className='faqhead'>How can Learn Tech Service help improve my child's education?</Accordion.Header>
                                <Accordion.Body className='faqbody'>
                                <p>Learn Tech Service is an educational initiative aimed at providing innovative learning solutions to students across India.</p>
                                </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="5">
                                <Accordion.Header className='faqhead'>Is Learn Tech Service affiliated with any educational institutions or boards?</Accordion.Header>
                                <Accordion.Body className='faqbody'>
                                <p>Learn Tech Service is an educational initiative aimed at providing innovative learning solutions to students across India.</p>
                                </Accordion.Body>
                            </Accordion.Item>

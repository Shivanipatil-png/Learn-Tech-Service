                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="containt">
                      <p className="upper">Learn Tech Service</p>
                      <h3>
                        Learn Everyday Any New Skills Online with Top
                        <span className='hignt1'>Instructors.</span>
                      </h3>
                      <p>
                        Learn Tech Service is dedicated to enhancing the
                ...
                <div className="col-lg-3 col-md-6 col-sm-12">
                  <div className="boxex box1"  data-aos="fade-up"  data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
                    <div className="cont">
                      ...
                      <p>
                        At Learn Tech Service is dedicated to enhancing the
        ...
        <div className="package">
          <div className="container">
            <div className="title text-center">
              ...
              <span>
                Learn Tech Service is dedicated to enhancing the educational

            ...
            <div className="container">
                ...
                <div className="col-lg-7 col-md-8">
                    <div className="bread-content">
                        <p className='text-white mb-0'>Join Learn Tech Service Edutech as a Coordinator for</p>
        ...
        <div className="page">
            <div className="howcan">
                <div className="container">
                    ...
                    <div className="col-lg-6">
                        <div className="para">
                            <p>Are you a passionate individual looking to make a positive impact on the education landscape? Are you motivated to empower students in their quest for success? If so, we invite you to become a Coordinator with Learn Tech Service Edutech, where opportunities abound and your potential is unlimited.</p>
                    ...
                    <div className="catagarybox">
                        ...
                        <div className="direct indirect">
                            <div className="row">
                                ...
                                <div className="col-lg-8">
                                    <div className="cordpara">
                                        <p>If you prefer working with schools, our Indirect Coordinator role is perfect for you. Collaborate with our Learn Tech Service Edutech team to enroll students in the BHARAT SAT Examination through their schools. Team up with us to make education accessible to all.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="recognizing path">
                                            ...
                                            <p>Choose the category that resonates with your skills and interests. We trust you to make the best choice for your unique abilities. After selection and appointment by Learn Tech Service Edutech, you'll embark on an exciting journey in your chosen domain.</p>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="recognizing rewards">
                                            <h4>Rewards for Excellence</h4>
                                            <p>At Learn Tech Service Edutech, we believe in recognizing and rewarding your performance. You'll earn commissions that directly reflect your dedication and results. The harder you work, the more you can achieve.</p>
                                        </div>
                                    </div>
                        ...
                        <div className="col-lg-5">
                            <div className="key">
                                ...
                                <p>Every Coordinator must adhere to the terms and conditions of Learn Tech Service. We prioritize ethical conduct, transparency, and dedication to our mission of fostering quality education.</p>
                                <div className="img">
                                    <img src={key} alt="" />
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="joincontent">
                                    ...
                                    <p>Take the step towards a fulfilling and rewarding journey by becoming a Coordinator for BHARAT SAT Examination with Learn Tech Service Edutech. Let's shape the future of education together!</p>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <div className="img">
